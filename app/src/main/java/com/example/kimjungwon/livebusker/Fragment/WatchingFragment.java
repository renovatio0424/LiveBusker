...
public class WatchingFragment extends FragmentActivity implements VideoRendererEventListener{
...
//    String path = "http://" + Server_IP + "/dog.mp4";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.draggable_layout);
        //비디오뷰 설정
...
//        });
        ...
        thumbnailImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(WatchingFragment.this, "thumbnail!", Toast.LENGTH_SHORT).show();
            }
        });
